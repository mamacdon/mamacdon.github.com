...
define(['orion/URITemplate', 'domReady!'], function(URITemplate, document) {
	var pluginsData = [
		...
		{	name: 'JavaScript outliner',
			...
			experimental: true,
			versions: {
				'>=1.0': ['http://mamacdon.github.io/outliner/outlinerPlugin.html', 'https://github.com/mamacdon/outliner']
			}
		},
		{	name: 'Nonymous outline',
			...
			experimental: true,
			versions: {
				'>=0.5': ['http://johnjbarton.github.io/outliner/nonymousPlugin.html', 'https://github.com/johnjbarton/outliner']
			}
		},
		{	name: 'CodeMirror',
		...
		{	name: 'Esprima outline',
			...
			versions: {
				'>=0.5': ['http://aclement.github.io/esprima-outline/esprimaOutlinerPlugin.html', 'https://github.com/aclement/esprima-outline']
			}
		},
		{
		...
		{	name: 'Pixlr',
			...
			versions: {
				'>=0.5': ['http://sfmccourt.github.io/plugins/pixlr/pixlrPlugin.html', 'https://github.com/sfmccourt/sfmccourt.github.com/blob/master/plugins/pixlr/pixlrPlugin.html']
			}
		},
		...
		{	name: 'Projects Prototype',
			description: 'Enable the prototype of supporting Projects within Orion. Adds a banner item for Projects',
			orionHome: true,
			versions: {
				'>=2.0': ['{OrionHome}/plugins/projectsPlugin.html', 'https://github.com/eclipse/orion.client/blob/master/bundles/org.eclipse.orion.client.ui/web/plugins/projectsPlugin.html']
			}
		},
		{	name: 'Snippet',
		...
		{	name: 'Line Delimiter Converter',
			...
			orionHome: true,
			versions: {
				'>2.0': ['{OrionHome}/plugins/delimiterPlugin.html', 'https://github.com/eclipse/orion.client/blob/master/bundles/org.eclipse.orion.client.ui/web/plugins/delimiterPlugin.js']
			}
		}
